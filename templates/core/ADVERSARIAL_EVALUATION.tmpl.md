...
|-------------|-------------|---------|
| `{{PROJECT_NAME}}` | Project name | Image Classification Robustness Study |
...
This contract defines the adversarial evaluation protocol for the **{{PROJECT_NAME}}** project. It specifies the threat model, attack and defense methods, robustness metrics, and disclosure requirements.
